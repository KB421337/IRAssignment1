...
python indexer.py
```
The time to build the  inverted index is displayed
...
python boolean.py
```
A prompt will be generated to type in the input query. The number and list of documents containing the result of the given query will be printed, along with the time taken to process the query.
